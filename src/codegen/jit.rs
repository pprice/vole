...
impl JitContext {
    ...
    fn register_runtime_symbols(builder: &mut JITBuilder) {
        ...
        builder.symbol(
            "vole_chain_iter",
            crate::runtime::iterator::vole_chain_iter as *const u8,
        );
        builder.symbol(
            "vole_chain_iter_next",
            crate::runtime::iterator::vole_chain_iter_next as *const u8,
        );
        builder.symbol(
            "vole_chain_iter_collect",
            crate::runtime::iterator::vole_chain_iter_collect as *const u8,
        );
        builder.symbol(
            "vole_flatten_iter",
            crate::runtime::iterator::vole_flatten_iter as *const u8,
        );
        builder.symbol(
            "vole_flatten_iter_next",
            crate::runtime::iterator::vole_flatten_iter_next as *const u8,
        );
        builder.symbol(
            "vole_flatten_iter_collect",
            crate::runtime::iterator::vole_flatten_iter_collect as *const u8,
        );
        builder.symbol(
            "vole_flat_map_iter",
            crate::runtime::iterator::vole_flat_map_iter as *const u8,
        );
        builder.symbol(
            "vole_flat_map_iter_next",
            crate::runtime::iterator::vole_flat_map_iter_next as *const u8,
        );
        builder.symbol(
        ...
        builder.symbol(
            ...
            crate::runtime::iterator::vole_string_chars_iter as *const u8,
        );
        builder.symbol(
            "vole_string_chars_iter_next",
            crate::runtime::iterator::vole_string_chars_iter_next as *const u8,
        );
