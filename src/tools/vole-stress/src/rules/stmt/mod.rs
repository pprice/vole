...
mod closure_struct_method;
mod closure_struct_return;
mod closure_when_capture;
mod closure_when_iter;
...
mod generic_closure_multi_inst;
mod generic_closure_param;
mod generic_interface_call;
mod generic_interpolation;
mod generic_iter_call;
mod generic_optional_closure;
mod generic_optional_multi_inst;
...
pub fn all() -> Vec<Box<dyn StmtRule>> {
    vec![
        ...
        Box::new(closure_capture_let::ClosureCaptureLet),
        ...
        Box::new(generic_closure_multi_inst::GenericClosureMultiInst),
        ...
        Box::new(generic_optional_closure::GenericOptionalClosure),
        Box::new(generic_optional_multi_inst::GenericOptionalMultiInst),
        ...
        Box::new(closure_capture_when::ClosureCaptureWhen),
